...
struct HomeView: View {
    ...
    var body: some View {
        VStack {
            ...
            // 控制吊扇
            DeviceControlView(deviceName: "吊扇", iconName: "fanblades.fill", color: .blue, deviceState: $ceilingFanState, actionCode: "1234", deviceIndex: 3, onDeviceStateChange: handleDeviceStateChange)
    ...
    func sendMessage(deviceIndex: Int, newState: String) {
        ...
        print(led2State)
        print(fanState)
        print(ceilingFanState)

        let messageDict: [String: Any] = [
            "user": "test_user",
            "action_code": "1234",
            "args": ["\(led1State)\(led2State)\(fanState)\(ceilingFanState)","0","0"]
        ]
